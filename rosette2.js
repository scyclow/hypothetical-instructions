...
function drawRibbedRosette(x, y, minRad, layers, {gears, rosetteRadiaChange, rosetteRotation, dist, colorFn, ...args}) {
  dist = dist || 15
  ...
  times(layers, t => {
    ...
    svg.drawPath(x, y, rosettePath, {
      rotation: t*rosetteRotation,
      stroke: colorFn ? colorFn(t) : args.stroke,
      ...args
    })
  })
}
